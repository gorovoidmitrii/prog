...
float const MAX_DISTANCE_2_BIG_APPLE = 21.5;
int const MIN_RED_VALUE_FOR_RED_COLOUR = 12;
int const MAX_GREEN_VALUE_FOR_RED_COLOUR = 13;
int const GREEN = 0;
int const RED = 1;
int const SMALL = 0;
int const BIG = 1;
