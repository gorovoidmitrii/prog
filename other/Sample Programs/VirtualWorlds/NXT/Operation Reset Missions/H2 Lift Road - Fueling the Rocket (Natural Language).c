...
{	//The program begins.
	...
	untilRotations(4.4, rightMotor);	//...until 4.4 rotations of the right motor encoder have been detected.
  ...
  untilEncoderCounts(70, rightMotor); //...until 70 counts of the right motor encoder have been detected.
  stop();				//The robot stops.

 	wait(1.0);		//The robot will wait for 1 second before executing other commands.

  startMotor(gripperMotor, 40);	//Turn the gripperMotor on POSITIVE to CLOSE it around the Fuel Barrel.
  wait(1.0);										//Give the gripperMotor 1 second to close...
  stopMotor(gripperMotor);			//...before stopping the gripperMotor.
