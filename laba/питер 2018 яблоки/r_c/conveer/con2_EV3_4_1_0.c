...
tEV3SensorTypeMode typeMode[2] = {infraRedProximity,touchStateBump};
...
/*task colODis()
{
	while (true)
	{
		...
		displayTextLine(2,"cod= %d", muxedSensor[1].touch);
		displayTextLine(3,"cod2= %d", colOrDis);
		if (muxedSensor[1].touch ==1)
		{
			if (colOrDis == 1)
			{
				colOrDis = 0;
