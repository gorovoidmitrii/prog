...
int const DISTANCE_TO_APPLE_MIN = 7;
int const DISTANCE_TO_THE_WALL = 18;//18 = 38-12(centre) 24 = 38 cm;//15
int const ENCODERS_360 = 1100;//1100;//1238;//1193;//1188;//1210;//1040;
...
void takeError()
{
	a[0] = MSDISTreadDist(sLeft);
	sleep(100);
	a[1] = MSDISTreadDist(sLeft);
	sleep(100);
	a[2] = MSDISTreadDist(sLeft);
	sleep(100);
	a[3] = MSDISTreadDist(sLeft);
	sleep(100);
	a[4] = MSDISTreadDist(sLeft);
	sleep(100);
	dv = MSDISTreadDist(sLeft);
	sort();
	errDist = abs(a[3]-GoodDist);
}
//-----------------------------------
void turnHelp(float degrees)
{
